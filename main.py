...
# 加载预训练的YOLOv8n模型
model = YOLO('C:/Users/师晋武/PycharmProjects/valve/best.pt')

# 单流媒体源批大小1推理
source = 'C:/Users/师晋武/PycharmProjects/valve/test/027.png'  # RTSP、RTMP、TCP或IP流媒体地址

# Press the green button in the gutter to run the script.
if __name__ == '__main__':
    results = model.predict(source, show=True)  # Results对象的生成器
    # cv2.waitKey()
    ...
    if len(results) == 0:
        ...
        if len(contours) < 0:
            ...
            logger.info(f"阀门占比是{mask_pixel / circle_area}")
